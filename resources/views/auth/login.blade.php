...
<head>
    ...
    <script src="{{ asset('resources/js/auth/login.js')}}?v={{ filemtime(resource_path('js/auth/login.js')) }}"></script>
    @include('layouts.theme')
    <link rel="stylesheet" href="{{ asset('resources/css/global.css') }}?v={{ filemtime(resource_path('css/global.css')) }}">
    <link rel="stylesheet" href="{{ asset('resources/css/login.css') }}?v={{ filemtime(resource_path('css/login.css')) }}">
</head>
